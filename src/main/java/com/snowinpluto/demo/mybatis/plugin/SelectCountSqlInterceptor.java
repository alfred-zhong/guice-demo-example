...
package com.snowinpluto.demo.mybatis.plugin;

import com.snowinpluto.demo.mybatis.plugin.OffsetLimitInterceptor.BoundSqlSqlSource;
...
public class SelectCountSqlInterceptor implements Interceptor {
	...
	private MappedStatement copyFromMappedStatement(MappedStatement ms,
		...
		Builder builder = new Builder(ms.getConfiguration(), ms
